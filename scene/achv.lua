        ...
        for i = 1 + 2 * max(floor(scroll1 / 140) - 1, 0), min(2 * (floor(scroll1 / 140) + 8), #achvLists[page]) do
            ...
            if not a.id then
                ...
                if a.progress > 0 then
                    ...
                    -- Dev
                    if a.overDev then
                        if a.id == 'ueEX' or a.id == 'ueEXeNH' or a.id == 'ueEXeMS' or a.id == 'ueEXeGV' or a.id == 'ueEXeVL' or a.id == 'ueEXeDH' or a.id == 'ueEXeIN' or a.id == 'ueEXeAS' or a.id == 'ueEXeDP' then
                            gc_setColor(1, 0, 0, .2)
                        elseif a.mod == "ZCEM" then
                            gc_setColor(0, 1, 0, .1)
                        else
                            gc_setColor(1, 1, 1, .1)
                        end
